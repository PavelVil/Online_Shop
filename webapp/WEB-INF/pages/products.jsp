...
<div class="products">
    <div class="container">
        <h2>${productByCategory.get(0).category.categoryName}</h2>
        <div class="col-md-9">
            <div class="content-top1">
                <c:forEach items="${productByCategory}" var="product">
                <div class="col-md-4 col-md4">
                    <div class="col-md1 simpleCart_shelfItem">
                        <a href="/FashionShop/product/${product.productId}">
                            <img class="img-responsive" src="/FashionShop/photo/${product.productId}" alt="" />
                        </a>
